...
public class SimpleVectorClockTest {

    // === increment Tests ===

    @Test
    void testIncrement() {
        SimpleVectorClock dvc = new SimpleVectorClock(1);
    ...
    void testMerge() {
        ...
        SimpleVectorClock dvc2 = new SimpleVectorClock(0);
        dvc2.increment();
    ...
    void testHappensBefore_SingleElementLess() {
        ...
        SimpleVectorClock v = new SimpleVectorClock(new long[]{1, 0}, 0);
        SimpleVectorClock w = new SimpleVectorClock(new long[]{2, 0}, 0);
    ...
    void testHappensBefore_AllElementsLessOrEqual() {
        ...
        SimpleVectorClock v = new SimpleVectorClock(new long[]{1, 2}, 0);
        SimpleVectorClock w = new SimpleVectorClock(new long[]{2, 3}, 0);
    ...
    void testHappensBefore_EqualClocks() {
        ...
        SimpleVectorClock v = new SimpleVectorClock(new long[]{1, 2}, 0);
        SimpleVectorClock w = new SimpleVectorClock(new long[]{1, 2}, 0);
    ...
    void testHappensBefore_ConcurrentClocks() {
        ...
        SimpleVectorClock v = new SimpleVectorClock(new long[]{1, 2}, 0);
        SimpleVectorClock w = new SimpleVectorClock(new long[]{2, 1}, 0);
    ...
    void testHappensBefore_DifferentLengths() {
        ...
        SimpleVectorClock v = new SimpleVectorClock(new long[]{1}, 0);
        SimpleVectorClock w = new SimpleVectorClock(new long[]{1, 1}, 0);
    ...
    void testHappensBefore_DifferentLengthsConcurrent() {
        ...
        SimpleVectorClock v = new SimpleVectorClock(new long[]{2}, 0);
        SimpleVectorClock w = new SimpleVectorClock(new long[]{1, 1}, 0);
    ...
    void testHappensBefore_ZeroClock() {
        ...
        SimpleVectorClock v = new SimpleVectorClock(new long[]{0, 0}, 0);
        SimpleVectorClock w = new SimpleVectorClock(new long[]{1, 0}, 0);
    ...
    void testHappensBefore_SequentialEvents() {
        ...
        SimpleVectorClock v = new SimpleVectorClock(new long[]{1, 0}, 0);
        SimpleVectorClock w = new SimpleVectorClock(new long[]{2, 0}, 0);
        SimpleVectorClock x = new SimpleVectorClock(new long[]{3, 0}, 0);
    ...
    void testHappensAfter_SingleElementGreater() {
        ...
        SimpleVectorClock v = new SimpleVectorClock(new long[]{2, 0}, 0);
        SimpleVectorClock w = new SimpleVectorClock(new long[]{1, 0}, 0);
    ...
    void testHappensAfter_AllElementsGreaterOrEqual() {
        ...
        SimpleVectorClock v = new SimpleVectorClock(new long[]{2, 3}, 0);
        SimpleVectorClock w = new SimpleVectorClock(new long[]{1, 2}, 0);
    ...
    void testHappensAfter_DifferentLengths() {
        ...
        SimpleVectorClock v = new SimpleVectorClock(new long[]{1, 1}, 0);
        SimpleVectorClock w = new SimpleVectorClock(new long[]{1}, 0);
    ...
    void testHappensAfter_SequentialEvents() {
        // Simulating sequential events on same node
        SimpleVectorClock v = new SimpleVectorClock(new long[]{3, 0}, 0);
        SimpleVectorClock w = new SimpleVectorClock(new long[]{2, 0}, 0);
        SimpleVectorClock x = new SimpleVectorClock(new long[]{1, 0}, 0);
    ...
    void testIsConcurrent_ThreeNodeScenario() {
        ...
        SimpleVectorClock node0 = new SimpleVectorClock(new long[]{1, 0, 0}, 0);
        SimpleVectorClock node1 = new SimpleVectorClock(new long[]{0, 1, 0}, 1);
        SimpleVectorClock node2 = new SimpleVectorClock(new long[]{0, 0, 1}, 2);
    ...
    void testIsConcurrent_AfterMerge() {
        ...
        SimpleVectorClock node0Before = new SimpleVectorClock(new long[]{1, 0}, 0);
        SimpleVectorClock node1Before = new SimpleVectorClock(new long[]{0, 1}, 1);
        ...
        // After merge
        SimpleVectorClock node0After = new SimpleVectorClock(new long[]{1, 0}, 0);
    ...
    void testIsConcurrent_AllZeroClocks() {
        ...
        SimpleVectorClock v = new SimpleVectorClock(new long[]{0, 0}, 0);
        SimpleVectorClock w = new SimpleVectorClock(new long[]{0, 0}, 0);
    ...
    void testIsConcurrent_PartialOverlap() {
        ...
        SimpleVectorClock v = new SimpleVectorClock(new long[]{2, 1}, 0);
        SimpleVectorClock w = new SimpleVectorClock(new long[]{1, 2}, 0);
    ...
    void testIsConcurrent_OneElementDifference() {
        ...
        SimpleVectorClock v = new SimpleVectorClock(new long[]{1, 1, 2}, 0);
        SimpleVectorClock w = new SimpleVectorClock(new long[]{1, 1, 3}, 0);
